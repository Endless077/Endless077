...
[![Follow](https://img.shields.io/github/followers/endless077.svg?style=social&label=Follow&maxAge=2592000)]()
...
[![Stack Exchange](https://img.shields.io/badge/connect-%2300843e.svg?style=for-the-badge&logo=symfony&logoColor=white)]()
...
I'm Antonio from Naples in Italy, I am a graduate student of the computer science degree course at the University of Naples - Federico II. <br/>
I'm lover of all about IT, in particular everything related to the world of IT security. I am interested in crypto and the blockchain world.
...
- 💻 I'm studying in the Master's at the [University of Salerno](https://www.unisa.it) (IT Security).
  
- 🔭 I'm currently working on personal project and some university project about IT Security, contact me for more details.  
  
- 💬 Ask me about...anything!  
 
- 💲 I invest in crypto and shares in my spare time, i use [Coinbase](https://www.coinbase.com/it/) or [Binance](https://www.binance.com/it).

- ⚡ Some fun fact: I surf the internet looking for penetration testing programs (i.e [NetHunter](https://www.kali.org/docs/nethunter/)).  
...
## 💾 Related
Some personal project (with contributors):

- [ESP32 IDS*](https://github.com/Endless077/ESP32_IDS)
- [ML Suite Test*](https://github.com/Endless077/ML_Security_Project)
...
- [C++ ASD Project](https://github.com/Endless077/Data-Structure-CPP)
- [MeBell](https://github.com/Endless077/MeBell)

*at moment private but i will publish soon.

## 🛠 Skills
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=java,python,c,cpp,cs,html,css,javascript,php,mysql,anaconda,androidstudio,arduino,atom,aws,azure,bash,bots,blender,cloudflare,dart,devto,discord,django,docker,dotnet,eclipse,emacs,express,fastapi,flask,figma,firebase,flutter,gamemakerstudio,gcp,git,github,gitlab,go,graphql,heroku,idea,jquery,kotlin,kubernetes,latex,linux,md,mongodb,nodejs,ps,postgres,postman,powershell,regex,selenium,solidity,spring,sqlite,stackoverflow,svg,twitter,unity,unreal,wordpress,xd,vim,visualstudio,vscode&perline=10" />
  </a>
</p>
...
<table align="center"><tr><td valign="top" width="50%">
  ...
  ![Languages](https://github.com/Endless077/Status/blob/master/generated/languages.svg)
  
</td><td valign="top" width="50%">

  ![Overview](https://github.com/Endless077/Status/blob/master/generated/overview.svg)
...
## 🔔 Help
For support or collaborations, email antonio.garofalo125@gmail.com or send me a message here. <br/>
<div align="left">
...
## ❤️ Greetings
 ...
 - Awessomeness, for Beginners, README, for Roadmaps, for Hacking and for CTF.
 - More github repository (see starred).

## ⚠️ Some favorite quotes
- "Fsociety" - Mr. Robot
- "Our democracy has been hacked" - Mr. Robot
- "Superheroes in New York? Gimme a break." - Stan Lee (The Avengers)
- "Remember remember, the fifth of november" - V for Vendetta

## 📚 Recommended source
Contact me for my personal repo with a lot of open source information, meanwhile, look at that:
