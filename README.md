## Endless077, or Antonio for friends! 👋
...
[![Hack The Box](https://img.shields.io/badge/HackTheBox-%239FEF00?style=for-the-badge&logo=hackthebox&logoColor=white)](https://profile.hackthebox.com/profile/019d1808-b7c8-73c1-b591-7ede1632bd18)
[![GitHub](https://img.shields.io/badge/github-%2324292e.svg?&style=for-the-badge&logo=github&logoColor=white)](https://github.com/Endless077)
...
### 🚀 About Me  
<p>
| Ethical Hacker | Penetration Tester | DevOps | Cyber Security & Gaming Enthusiast |
</p>

<p>
I'm Antonio from Naples, Italy. I earned my Bachelor's degree in Computer Science 
from the University of Naples Federico II and my Master's degree from the University 
of Salerno, specializing in Cyber Security.
</p>

<p>
I am passionate about all things IT, with a strong focus on information security, 
vulnerability analysis, secure software development, and system protection. 
I enjoy building innovative solutions while continuously exploring the evolving 
...
<table>
  ...
  - 🎓 Bachelor's degree at the [University of Naples](https://www.unina.it) (Computer Science).
    
  - 🎓 Master's degree at the [University of Salerno](https://www.unisa.it) (IT Security).
...
- [HPC Project (Game of Life)](https://github.com/Endless077/Game_Of_Life)
...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=anaconda,androidstudio,angular,apple,arch,arduino,atom,aws,azure,bash,bitbucket,blender,bootstrap,bots,c,cs,cpp,clion,cloudflare,cmake,codepen,css,dart,debian,devto,discord,discordjs,django,docker,dotnet,eclipse,emacs,express,fastapi,figma,firebase,flask,flutter,fortran,gamemakerstudio,gcp,git,github,gmail,gitlab,go,godot,gradle,graphql,haskell,heroku,html,htmx,idea,java,js,jquery,kali,kotlin,kubernetes,latex,linux,lua,md,maven,mongodb,mysql,nodejs,notion,npm,obsidian,perl,ps,php,postgres,postman,powershell,pycharm,py,pytorch,qt,r,rabbitmq,raspberrypi,react,redhat,regex,remix,ros,spring,sqlite,stackoverflow,styledcomponents,sklearn,selenium,solidity,svg,swift,tensorflow,twitter,ts,windows,wordpress,yarn,vercel,vim,vite,vue,ubuntu,unity,unreal,visualstudio,vscode&perline=25" />
  </a>
</p>
...
## 📚 Recommended Sources
Contact Me for my personal repositories with a lot of open-source information. <br/>
...
- Linux Basics for Hackers (Getting Started with Networking) - OccupyTheWeb
- The Hacker Playbook 1 (Practical Guide To Penetration Testing) - Peter Kim
- The Hacker Playbook 2 (Practical Guide To Penetration Testing) - Peter Kim
- The Web Application Hackers Handbook - Dafydd Stuttrad, Marcus Pinto
- Web Hacking 101 (How to Make Money Hacking Ethically) - Peter Yaworski
- Web Penetration Testing with Kali - Joseph Muniz, Aamir Lakhani
- Nmap Network Scanning (The Official Nmap Project Guide to Network Discovery and Security Scanning) - Gordon Fyodor Lyon
- The Basics Of Hacking And Penetration Testing (Ethical Hacking And Penetration Testing Made Easy) - Patrick Engebreatson
- Hacking (The Art of Exploitation) - Jon Erickson 
- Social Engineering (The Art of Human Hacking) - Christopher Hadnagy
- Gray Hat Hacking - A. Harper, S. Harris, J. Ness, C. Eagle, G. Lenkey, T. Williams
- Hackers (Heroes of the Computer Revolution) - Steven Levy
- Hacker 7.0 - Stuart McClure, George Kurtz, Joel Scambray
- Cybersecurity for Beginners - Heimdal Security 
- Cybersecurity for Beginners - Raef Meeuwisse
- The Wireless Cookbook - Bill Zimmerman
